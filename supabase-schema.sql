...
INSERT INTO public.projects (title, description, long_description, image, technologies, demo_url, github_url, featured) VALUES
(
    'E-Commerce Platform',
    ...
    ARRAY['React', 'Node.js', 'PostgreSQL', 'Stripe', 'TypeScript'],
...
(
    ...
    '/placeholder.svg?height=300&width=500',
    ARRAY['Next.js', 'Socket.io', 'MongoDB', 'Tailwind CSS'],
    'https://tasks.example.com',
    'https://github.com/username/taskapp',
    true
);

INSERT INTO public.blog_posts (title, excerpt, content, image, tags, slug, featured, published_at, read_time) VALUES
(
    'Building Scalable React Applications',
    'Learn the best practices for building large-scale React applications that can grow with your team.',
    '<p>Building scalable React applications requires careful planning and adherence to best practices. In this comprehensive guide, we''ll explore the key principles and patterns that will help you create maintainable and performant React applications.</p><h2>Component Architecture</h2><p>The foundation of any scalable React application is a well-thought-out component architecture.</p>',
    '/placeholder.svg?height=300&width=500',
    ARRAY['React', 'JavaScript', 'Architecture', 'Best Practices'],
    'building-scalable-react-applications',
    true,
    NOW() - INTERVAL '5 days',
    8
...
(
    ...
    '<p>The web development landscape is constantly evolving, with new technologies and methodologies emerging regularly. In this article, we''ll explore some of the most exciting trends that are shaping the future of web development.</p><h2>Key Trends</h2><p>From AI-powered development tools to edge computing, the future looks bright for web developers.</p>',
    '/placeholder.svg?height=300&width=500',
